    ...
    return (
        <StyledView marginTop={35} alignItems={'center'}>
                    ...
                    <StyledView row spaceBetween width={260} right={5}>
                        <StyledView>
                            ...
                            <StyledText position={'absolute'} top={3} size12 yellow>
                                {[1, 2, 3, 4].includes(step) ? <StyledText black>✔</StyledText> : '1'}
                            </StyledText>
                        </StyledView>
                        <StyledView>
                            {handleSteps(2) ? <RadioButton completed /> : <RadioButton />}
                            <StyledText position={'absolute'} top={3} size12 yellow>
                                {[2, 3, 4].includes(step) ? <StyledText black>✔</StyledText> : '2'}
                            </StyledText>
                        </StyledView>
                        <StyledView>
            ...
            <StyledView row spaceBetween width={316} left={2} marginTop={20}>
                <StyledText size10 lineHeight={12} flex={1}>Carrito</StyledText>
                <StyledText size10 lineHeight={12} flex={1}>Entrega</StyledText>
                <StyledText size10 lineHeight={12} flex={1}>Pago</StyledText>
                <StyledText size10 lineHeight={12} flex={1}>Pedido completado</StyledText>
            </StyledView>
        </StyledView>
    );
};
