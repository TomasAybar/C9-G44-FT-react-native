...
import { Button, StyleSheet, Text, View, TouchableOpacity, useWindowDimensions } from 'react-native'
...
export const DetalleDonarScreen = () => {
  ...
  const handleChoosePhoto = async () => {
	...
	return (
		<KeyboardAwareScrollView style={{backgroundColor: theme.colors.appBackground}}>
		<Formik
