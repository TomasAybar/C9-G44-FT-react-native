  ...
  return (
    <StyledView dark container height100>
      <View style={styles.containerTitle}>
        <Image source={require('../../../../assets/icons/tab-bar/donar.png')} />
      ...
      <ListPaso
        number='1'
        content='Ingresa a la sección “donar” y subí fotos del producto (podrás subir hasta 5 imágenes).'
      />
      <ListPaso
        number='2'
        content='Ingresa la cantidad de artículos que querés donar y agrega una breve descripción.'
      />
      <ListPaso
        number='3'
        content='Indica fecha, rango horario y dirección, para poder coordinar la entrega.'
      />
