...
import { FotoProductoScreen } from '../screens/vender/screens/FotoProductoScreen'
import { CategoriasScreen } from '../screens/comprarViejo/CategoriasScreen'
import { CategoriaScreen } from '../screens/comprarViejo/CategoriaScreen'
import { TipoProductoScreen } from '../screens/vender/screens/TipoProductoScreen'
import { DescripcionScreen } from '../screens/vender/screens/DescripcionScreen'
import { MetodoPagoScreen } from '../screens/vender/screens/MetodoPagoScreen'
import { CheckeoFinalScreen } from '../screens/vender/screens/CheckeoFinalScreen'
import { ArticuloPublicado as ArticuloPublicadoVender } from '../screens/vender/screens/ArticuloPublicado'
import { Producto } from '../screens/comprarViejo/Producto'
import { DetalleDonarScreen } from '../screens/donar/screens/DetalleDonarScreen'
import { InformacionScreen } from '../screens/donar/screens/InformacionScreen'
import { DonacionExitosa } from '../screens/donar/screens/DonacionExitosa'
import { ArticuloPublicado as ArticuloPublicadoDonar } from '../screens/donar/screens/ArticuloPublicado'
import { CategoriaScreen as CategoriaScreenVender } from '../screens/vender/screens/CategoriaScreen'
import { Carrito } from '../screens/comprarViejo/Carrito'
import { MetodoDeEntrega } from '../screens/comprarViejo/MetodoDeEntrega'
import { MetodoDePago } from '../screens/comprarViejo/MetodoDePago'
import { SeleccionEfectivo } from '../screens/comprarViejo/SeleccionEfectivo'
import { SeleccionTarjeta } from '../screens/comprarViejo/SeleccionTarjeta'
import { ProcesamientoPago } from '../screens/comprarViejo/ProcesamientoPago'
...
import { CongratsScreen } from '../screens/vender/screens/CongratsScreen'
...
export const StackNavigation = () => {
  ...
  return (
    ...
    >
      ...
      <Stack.Screen
        name='Selecciona un método de entrega'
        component={MetodoDeEntrega}
      />
      <Stack.Screen
      ...
      />
      <Stack.Screen
        name='CategoriaScreenVender'
        component={CategoriaScreenVender}
      ...
      <Stack.Screen
        ...
        options={{ headerTitle: 'Detalle de la donación' }}
      />
      <Stack.Screen
        name='InformacionScreen'
        component={InformacionScreen}
        options={{ headerTitle: 'Información para recolección' }}
      />
      <Stack.Screen
        name='DonacionExitosa'
        component={DonacionExitosa}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name='ArticuloPublicadoDonar'
        component={ArticuloPublicadoDonar}
        options={{ headerTitle: 'Publicaciones' }}
      />
